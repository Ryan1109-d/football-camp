...
| 彈性接送 | 最早 08:00 送達、最晚 18:00 接回 |
| 對象 | 國小 3–6 年級（報名表年級選項含「其他」） |
| 地點 | 清華大學南大校區 體健大樓五樓室內＋室外操場 |
| 價格 | 一般 **$7,800**／優惠 **$7,500** |
| 優惠資格 | 早鳥（11/30 前）／團報 5 人／清大教職員，**三擇一不可疊加** |
...
1. Google Sheet 建立分頁 `報名名單`，第一列填**這 25 欄**，順序不能動（程式按位置寫入）：
...
| `calcAmount` / `buildPaymentBody` | 依報名時間與優惠身份算金額、組繳費通知內容 |
